...
void UInv_GridSlot::NativeOnMouseEnter(const FGeometry& Geometry, const FPointerEvent& MouseEvent)
{
...
FReply UInv_GridSlot::NativeOnMouseButtonDown(const FGeometry& Geometry, const FPointerEvent& MouseEvent)
{
