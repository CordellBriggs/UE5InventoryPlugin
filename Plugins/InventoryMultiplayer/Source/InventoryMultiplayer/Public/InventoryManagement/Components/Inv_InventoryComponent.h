...
class INVENTORYMULTIPLAYER_API UInv_InventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
//	void GetItemManifest();
	...
	// Sound to play when inventory is closed
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Inventory|Audio")
	TObjectPtr<USoundBase> CloseInventorySound;
