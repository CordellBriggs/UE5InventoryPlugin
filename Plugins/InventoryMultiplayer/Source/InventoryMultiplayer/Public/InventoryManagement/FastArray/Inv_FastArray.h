...
struct FInv_InventoryFastArray : public FFastArraySerializer
{
	...
	//TODO:  ADD AND REMOVE ITEM FUNCTIONS ARE HERE BELOW!//
	
	//These are the functions that will be used to add and remove items from the inventory.
	// They will be called by the Inventory Component and will handle the actual adding/removing of items.
	// They will also handle the replication of the items to clients.
