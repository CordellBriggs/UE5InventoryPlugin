...
/**
 * The Hover item is the item that will appear and follow the mouse when an inventory item on the grid has been clicked.
 */
...
class UInv_InventoryItem;
UCLASS()
class INVENTORYMULTIPLAYER_API UInv_HoverItem : public UUserWidget
{
	GENERATED_BODY()
public:
